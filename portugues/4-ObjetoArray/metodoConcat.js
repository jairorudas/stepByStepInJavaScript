...
console.log(arr) //Retorna [1, 2, 5, 4, 7, "Televisão", 100]

//exemplo 2:
var arr = [1,2,5,4,7];
arr.concat([123,456,789,"abc"]);
console.log(arr); /* Aqui retorna [1, 2, 5, 4, 7, 123, 456, 789, "abc"].
...
console.log(arr); /* Retorna [1, 2, 5, 4, 7, Array[4]0: 1471: 2582: 3693: "jairo"length: 4__proto__: Array[0]]. Repare que
criamos um Array dentro de um Array. Aqui Sim faz toda diferencia usar dois pares de corchetes para abrir e fechar*/

//exemplo 4:
var arr = [1,2,5,4,7];
arr.concat({"Nome": "Jairo"}, {"Cargo": "Front-end"});
console.log(arr); /*Retorna [1, 2, 5, 4, 7, Object, Object], dois Objetos, lembremos que um objetos são criados com chaves
 ({}), e é possivel adicionar mais de um objeto.*/

//Exemplo 5:
var arr = [1,2,5,4,7];
arr.concat([28,32], [96,"node"]);
console.log(arr); /*Retorna [1, 2, 5, 4, 7, 28, 32, 96, "node"], Repare que aqui tanto faz também colocar
...
caju.concat(morango); // Concat acrescenta a nosso Array os dados contidos em morango, SEM CRIAR UM NOVO ARRAY dentro de caju.
...
laranja.push(limao);
console.log(laranja); /* O metodo "PUSH" indexa dentro de nosso Array Laranja outro Array, quer dizer temos um Array e dentro
temos outro Array. Para enchergar melhor cola copia e cola esse codigo na consola do Browser. */

var acerola = new Object();
laranja.push(acerola); /* IMPORTANTE: O comportamento de "push()" é igual que o comportamento de "concat()" quando acrescentamos
