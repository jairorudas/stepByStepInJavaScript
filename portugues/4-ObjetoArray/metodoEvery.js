...
//Exemplo: 2
 ...
 function testNumeros(elem, ind, obj){
    //obj aqui é a variavel NUMEROS, ela está sendo percorrida.
...
//Exemplo: 3
 ...
 function testNumeros(elem, ind, obj){
     return (elem instanceof String); // Retorna FALSE
     /*
        * Lembre que dentro de este test você pode colocar qualquer tipo de coisa que você quiser testar do Array que está sendo
          percorrido.
    */
 ...
 /*
    * Retona false, aqui perguntamos a  JavaScipt se os elementos do Array numeros TODOS são uma instancia
...
console.log(retorno);
// Retorna True, pois todos os elementods do Array satisfazem a condição da função callback.

/*
    # O navegador Internet explorer 8 não suporta este metodo até hoje 08/10/2015.
*/
